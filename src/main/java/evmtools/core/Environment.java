...
public class Environment {
	...
	public JSONObject toJSON() throws JSONException {
		...
		json.put("currentCoinbase", Hex.toHexString(currentCoinbase,20));
		...
		json.put("currentWithdrawalsRoot", Hex.toHexString(currentWithdrawalsRoot,20));
		json.put("currentBeaconRoot", Hex.toHexString(currentBeaconRoot,20));
